    ...
    <div class="ratings-wrapper">
      ...
      <div class="content">
       <div class="rating-select" v-if="ratings.tab">
          <span class="item" @click="selectType(2)" :class="{'active':selType==2}">{{ratings.tab[0].comment_score_title}}</span>
          <span class="item"  @click="selectType(1)" :class="{'active':selType==1}">{{ratings.tab[1].comment_score_title}}</span>
          <span class="item"  @click="selectType(0)" :class="{'active':selType==0}">
            <img src="./img/icon_sub_tab_dp_normal@2x.png" v-if="selType!=0" />
            <img src="./img/icon_sub_tab_dp_highlighted@2x.png" v-if="selType===0" />
            {{ratings.tab[2].comment_score_title}}
          </span>
       </div>
       <div class="labels-view" v-if="ratings">
